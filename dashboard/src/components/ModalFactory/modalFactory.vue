...
const ModalLogin = defineAsyncComponent(() => import('@/components/modalLogin/modalLogin.vue'))
const ModalCreateAccount = defineAsyncComponent(() => import('@/components/ModalCreateAccount/modalCreateAccount.vue'))
...
const DEFAULT_WIDTH = 'w-3 lg:w-1/3'
    ...
    function handleModalToggle(payload) {
      if (payload.status) {
        ...
        state.component = {}
        state.props = {}
        state.DEFAULT_WIDTH = DEFAULT_WIDTH
      }
